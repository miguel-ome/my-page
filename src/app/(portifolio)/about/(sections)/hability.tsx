  ...
  return (
    <>
      ...
      <p className="text-start my-5 whitespace-pre-line" id="summary">
        <TypingEffect
          paragraphs={[
            `Frontend: utilizo o React como tecnologia de front, e um dos motivos foi sua versatilidade para com o mobile (React-Native). Então, trabalho com Nextjs para criação de SPA's e SSR's:\n - React \n - NextJs \n - Styled Components \n - TailwindCSS \n - React-Native (em andamento ✍)\n`,
            ...
            'Outros: deixei esse paragrafo disponível para trazer os conhecimentos complementares, mas sem especificar uma área específica, mas que uso constantemente no meu desenvolvimento de códigos:\n - Javascript e Typescript \n - C# (em andamento ✍) \n - Versionamento de Git (Git) \n - Github \n - Docker (em andamento ✍) \n - API Rest \n - JWT | OAuth | Passport \n - CI/CD (em andamento ✍) \n - TDD (em andamento ✍)',
          ]}
          speed={25}
        />
      </p>
